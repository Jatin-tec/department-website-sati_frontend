        ...
        <Container fluid>
            ...
            <Row className="align-items-center">
              <Col md={8}>
                ...
                <ol className="breadcrumb m-0">
                  <li className="breadcrumb-item active">Welcome {"name"}</li>
                </ol>
              </Col>
          ...
          <Row>
            <Col xl={9}>
              <Card>
                <CardBody>
                  <h4 className="card-title mb-4">Time Table</h4>
                  <Row>
                    <Col lg={7}>
                      <div>
                        {/* <LineAreaChart /> */}
            ...
            <Col xl={3}>
              <Card>
                <CardBody>
                  <div>
                    <h4 className="card-title mb-4">Subjects</h4>
                  </div>
                  
                  <Link to="/detailed-class">
